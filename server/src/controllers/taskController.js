...
export const createTask = async (req, res) => {
  try {
    ...
    } else if (project.team_lead !== userId) {        // fixed: was elseif
...
export const updateTask = async (req, res) => {
  try {
    const task = await prisma.task.findUnique({   // fixed: was findunique
...
export const deleteTask = async (req, res) => {
  try {
    ...
    const tasks = await prisma.task.findMany({    // fixed: was findmany
